...
export default class KeylightdControlPreferences extends ExtensionPreferences {
    fillPreferencesWindow(window) {
        ...
        const generalPage = new GeneralPrefs.GeneralPage(window._settings, SettingsKey);
        const groupsPage = new GroupsPrefs.GroupsPage(window._settings, SettingsKey);
        const lightsPage = new LightsPrefs.LightsPage(window._settings, SettingsKey);
