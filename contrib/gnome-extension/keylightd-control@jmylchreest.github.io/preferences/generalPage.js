...
class KeylightdGeneralPage extends Adw.PreferencesPage {
    _init(settings, settingsKey) {
        ...
        this._settings.bind('api-url', httpURL, 'text', Gio.SettingsBindFlags.DEFAULT);
        ...
        // Add description below the entry row
        httpAPIKey.set_tooltip_text(_('The API Key provided by the keylightd server'));
        
        this._settings.bind('api-key', httpAPIKey, 'text', Gio.SettingsBindFlags.DEFAULT);
        ...
        let refreshSettingsGroup = new Adw.PreferencesGroup({
            ...
            description: _('Configure how often lights and groups status are updated')
        });
        ...
        // Add description
        debounceRow.set_tooltip_text(_('Higher values reduce network traffic but make controls less responsive'));
        ...
        this._settings.bind('enable-logging', loggingRow, 'active', Gio.SettingsBindFlags.DEFAULT);
