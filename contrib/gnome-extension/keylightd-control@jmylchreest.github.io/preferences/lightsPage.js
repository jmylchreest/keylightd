...
export var LightsPage = GObject.registerClass({
    ...
    _init(settings, settingsKey) {
        ...
        showAllButton.connect('clicked', () => this._toggleAllLightsVisibility(true));
        hideAllButton.connect('clicked', () => this._toggleAllLightsVisibility(false));
    ...
    async _loadLights() {
        ...
        try {
            ...
            lightsArray = lightsArray.sort((a, b) => (a.name || '').localeCompare(b.name || '', undefined, {numeric: true, sensitivity: 'base'}));
            ...
            this._spinner.stop();
            this._spinner.visible = false;
            this._setStatus(_('Error loading lights. Check connection settings.'), true);
            this._noLightsLabel.visible = false;
            this._lightsList.visible = false;
            this._updateUIState();
        }
